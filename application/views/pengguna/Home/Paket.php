            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div class="card" style='background-image: url("assets/img/farmer.jpg");' data-aos="fade-up" data-aos-delay="200">
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-family:Playlist-Caps;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magnam officia cumque mollitia beatae delectus incidunt illum!</p>
                        <p class="card-text">Rp. 500.000,00</p>
                    </div>
                </div>
            </div>
